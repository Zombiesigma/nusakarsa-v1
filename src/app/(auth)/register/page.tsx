      ...
      >
        <div className="flex flex-col items-center text-center space-y-4 mb-8">
          ...
          <div className="space-y-1 text-white">
            <h1 className="text-3xl sm:text-4xl font-headline font-black tracking-tight drop-shadow-lg">Buat <span className="text-white/80 italic">Karya.</span></h1>
            <p className="text-white/80 font-medium text-xs sm:text-sm drop-shadow-md">Bergabunglah dalam barisan pujangga modern.</p>
          </div>
        </div>
